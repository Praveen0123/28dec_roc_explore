...
import { LifetimeEarningsService, RoiModelDto } from '@app/domain';
...
export class LifetimeEarningsGraphComponent implements OnInit
{
  ...
  @Output('onCalculatorResultsReceived') calculatorResultsReceivedEventEmitter = new EventEmitter<RoiCalculatorOutputModel>();
