...
export class EducationCost extends Entity<EducationCostProps>
{
  ...
  clearStartSchoolYear()
  {
    this.props.startYear = null;
  }

  clearPartTimeFullTime()
  {
    this.props.isFulltime = true;
  }

  clearYearsToComplete()
  {
    this.props.yearsToCompleteDegree = CONFIG.EDUCATION_COST.YEARS_TO_COMPLETE_DEFAULT;
  }
