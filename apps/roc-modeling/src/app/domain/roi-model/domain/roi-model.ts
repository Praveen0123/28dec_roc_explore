...
export class RoiModel extends Entity<RoiModelProps>
{
  ...
  clearCareerGoalLocation()
  {
    this.props.careerGoal.clearLocation();
  }

  clearCareerGoalOccupation()
  {
    this.props.careerGoal.clearOccupation();
  }

  clearCareerGoalDegreeLevel()
  {
    this.props.careerGoal.clearDegreeLevel();
  }

  clearCareerGoalDegreeProgram()
  {
    this.props.careerGoal.clearDegreeProgram();
  }

  clearCareerGoalRetirementAge()
  {
    this.props.careerGoal.clearRetirementAge();
  }
  ...
  clearEducationCostInstitution()
  {
    this.props.educationCost.clearInstitution();
  }

  clearEducationCostStartSchoolYear()
  {
    this.props.educationCost.clearStartSchoolYear();
  }

  clearEducationCostPartTimeFullTime()
  {
    this.props.educationCost.clearPartTimeFullTime();
  }

  clearEducationCostYearsToComplete()
  {
    this.props.educationCost.clearYearsToComplete();
  }
